...
var api = {
  ...
  token: "1968d1e523f99b9563f5cbf37e84e0e1", // TODO 0 add your api key DONE?
  /**
...
function searchMovies(query, callback) {
  ...
  $.ajax({
    url: api.root + "/search/keyword", // url for searching keywords
    data: {
      api_key: api.token,
      query: query
    },
    success: function(response) {
      ...
      var keywordWcommas = keywordIDs.join(); 
      console.log(keywordWcommas);
